...
import { MarginProps, width, WidthProps } from 'styled-system'
...
export interface ExtFieldProps extends WidthProps, Omit<AccessibleFieldProps, 'children'> {}
...
const AccessibleFieldBase = React.forwardRef<HTMLDivElement, AccessibleFieldProps>(
  function AccessibleField(props: AccessibleFieldProps, extRef) {
    const {
      alignTooltip = 'right',
      autoTooltip = true,
      children,
    ...
    const ref = useMergedRefs(extRef)
