...
import { Grid, IconButton, Text, ScreenSizeContext, SIZES, StyleProvider } from '../'
...
const IconButtonBase = ({ size, disabled, isTiny }: { size: IconButtonSizes; disabled?: boolean, isTiny?: boolean}) => {
