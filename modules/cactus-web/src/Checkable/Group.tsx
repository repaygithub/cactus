...
type GroupProps = ExtFieldProps & CheckableGroupProps

const CheckableGroup = React.forwardRef<HTMLDivElement, GroupProps>((props, ref) => {
  const { children, ...fieldProps } = useCheckableGroupProps(props)
  return (
    <AccessibleField role="group" {...fieldProps} ref={ref}>
