// This is a copy of the rules form that doesn't use a form library, so we can
// test the fields by themselves. We probably won't maintain it forever, though.
                      ...
                      {rule.conditions.map((condition, conditionIndex): ReactElement => {
                        return (
                          <FieldsAccordion
                            ...
                            lastIndex={rule.conditions.length - 1}
                      ...
                      {rule.actions.map(
                        (action, actionIndex): ReactElement => (
                          <FieldsAccordion
                            ...
                            key={action.key}
                            index={actionIndex}
                            lastIndex={rule.actions.length - 1}
