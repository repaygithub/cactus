import { Accordion, Flex, Text } from '@repay/cactus-web'
        ...
        >
          <Flex padding="16px" width="90%">
            <Accordion.Provider maxOpen={2}>
              <Accordion>
                <Accordion.Header> What is EBPP? </Accordion.Header>
                <Accordion.Body>
                  Electronic Bill Payment and Presentment (EBPP) is a process, which companies use
              ...
              <Accordion>
                <Accordion.Header> Why EBPP? </Accordion.Header>
                <Accordion.Body>
                  Electronic Bill Payment and Presentment (EBPP) is quick and convienent. The
              ...
              <Accordion>
                <Accordion.Header> What is Bill Presentment? </Accordion.Header>
                <Accordion.Body>
                  Bill presentment is an online system that allows customers to receive and view
              ...
              <Accordion>
                <Accordion.Header> Cat Mojo I Show My Fluffy Belly? </Accordion.Header>
                <Accordion.Body>
                  Sleep on my human's head behind the couch, yet stand in front of the computer
              ...
              <Accordion>
                <Accordion.Header> Office Ipsum? </Accordion.Header>
                <Accordion.Body>
                  Other agencies charge much lesser I know somebody who can do this for a reasonable
