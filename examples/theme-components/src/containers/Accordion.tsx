...
const AccordionComponent: React.FC<RouteComponentProps> = (): ReactElement => {
            ...
            (header, index): ReactElement => (
              <Accordion variant="outline" key={header}>
                ...
                <Accordion.Body>
                  ...
                  Vestibulum lacinia ultrices urna, non rhoncus justo mollis vitae. Integer
                  facilisis gravida ex, nec euismod augue aliquam vel.
                </Accordion.Body>
              </Accordion>
            )
          )}
